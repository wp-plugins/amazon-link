...
<p>It is recommended that the Affiliate IDs in the default channel as set up, as some sections of the site (e.g. shortcodes inserted in sidebar widgets) do not have an \'author\'.</p>
...
<p>In the future it is intended that the plugin will allow the user to specify Channels by post category/tag/parent, etc.</p>
',
  ),
...
<p>If the Channel selected does not contain affiliate IDs for all locales then ones from the \'default\' Channel will be automatically inserted.</p>
